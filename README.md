...
- 总览表首行展示 5 日成交额占比，用于辅助观察二级市场交易热度。
- 明细表展示当日涨跌幅、5 日成交额占比、各窗口净申购、各窗口净申购占比、当日 ETF 规模。
- 点击明细行可展开 60 日分天涨跌幅、5 日滑动窗口成交额占比、分天净申购金额和 5 日滑动窗口净申购金额走势。
...
- 5 日成交额占比：使用近 5 个交易日场内成交额合计除以窗口期初 ETF 规模，衡量二级市场交易热度，不等同于一级市场净申购资金流。
- 当日 ETF 规模：使用最新份额乘以最新收盘价估算。
- 当日/分天涨跌幅：按对应交易日收盘价相对上一 ETF 交易日收盘价计算，并按当日 ETF 规模加权聚合。
